...
public class MasterSolutionOrderList {
    ...
    public SolutionOrder newSolutionOrder(SolutionOffer soloffer,  MarketChannelAssignment mca,CustomerProfile customerProfile ) {

        SolutionOrder so = new SolutionOrder(soloffer, mca, customerProfile);
